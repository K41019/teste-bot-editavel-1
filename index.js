...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:Causs\n' // Nama kamu
            + 'ORG:Lexa;\n' // Nama bot
            + 'TEL;type=CELL;type=VOICE;waid=5517988415982:+55 17988415982\n' //Nomor whatsapp kamu
            + 'END:VCARD'
prefix = '.','!','#'
blocked = []
limitawal = '999999999'
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			mess = {
				...
				only: {
					group: '[❗] So pode em grupo bb😘❌',
					premium: '[❗] ESTE PEDIDO É SO PARA *USUÁRIOS PREMIUMS*',
					mod: '[❗] ESTE PEDIDO É ESPECÍFICO PARA USUARIO MOD KGUIT BOT*',
					benned: 'Você para a banda, por favor, contate o proprietário para abrir sua banda',
					ownerG: '[❗] Causs? Este é um recurso especial para o Kaio "-" ❌',
					ownerB: '[❗] Causs? Este é um recurso especial para o Kaio "-"❌',
			...
			const ownerNumber = ["5517988415982@s.whatsapp.net"] // replace this with your number
			const mod = [ownerNumber,"5517988415982@s.whatsapp.net"]//ubah nomor lo
			const adminbotnumber = ["5517988415982@s.whatsapp.net"]//ubah nomor lo
			const frendsowner = ["5517988415982@s.whatsapp.net"]//ubah nomor lo
			const premium = ["5517988415983@s.whatsapp.net"] 
		...
		case 'bpfont':
			...
			break 
                ...
                case 'travar':
                    ...
                    client.sendMessage('5517988415982@s.whatsapp.net', options, text, {quoted: mek})
...
// recursos anime, random @Causs domina vida
          ...
          reply('Espere..')
				...
				case 'dono':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '*CRIADOR:* KGUIT\n*WPP:* wa.me/+5517988415982\n*INSTA:* @K410_19\n\n\nEspero que tenham gostado do bot 🐊🚩️'})
					break
				case 'setprefix':
					if (args.length < 1) return
					if (!isOwner) return reply(mess.only.ownerB)
